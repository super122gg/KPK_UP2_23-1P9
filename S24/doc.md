...
| status_id | Идентификатор статуса  | Нет | Integer | > 0 | 1 (active) |
...
| status_id | Новый идентификатор статуса | Нет | Integer | > 0 | - |
...
| status_id | Идентификатор статуса для фильтрации | Integer | Фильтрация по ID статуса |
...
| status_id | Идентификатор статуса | Необязательно | Integer | > 0 | 1 |
...
| status_id | Новый идентификатор статуса | Необязательно | Integer | > 0 | None |
...
| status_id | ID статуса для фильтрации | Необязательный | Integer |
...
| 2 | Исключить записи: is_deleted == True ИЛИ status_id == 2 (cancelled) |
